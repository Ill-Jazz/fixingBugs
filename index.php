...
if(!empty($_POST['firstname']) && !empty($_POST['lastname'])) {
    ...
    if(!empty($_POST['id'])) {
        ...
        // The UPDATE statement is used to modify the existing records in a table. Changed Values to SET because the wrong syntax was used.
...
elseif(isset($_POST['delete'])) {
    ...
    $handle = $pdo->prepare('DELETE FROM user WHERE id=:id'); // You need to specify which user id
